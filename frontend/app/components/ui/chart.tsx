...
// Fully explicit interface — no inheritance from recharts TooltipProps/TooltipContentProps
...
// Explicit interface — avoids Pick<LegendProps, "payload" | "verticalAlign"> which breaks in v3
