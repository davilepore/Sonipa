      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full" style={{ backgroundColor: '#EEA71E', color: '#ffffff' }}>
              <Sparkles className="w-4 h-4" />
              <span className="text-sm font-medium">ONG de Proteção Animal</span>
            </div>
            
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
              Adote um Amigo de <span style={{ color: '#EEA71E' }}>Quatro Patas</span>
            </h2>
            
            <p className="text-xl text-gray-600">
              Na SONIPA, resgatamos, cuidamos e encontramos lares amorosos para cães que precisam de uma segunda chance. Cada adoção transforma duas vidas.
            </p>
            ...
            <div className="flex gap-8 pt-4">
              <div>
                <p className="text-3xl font-bold" style={{ color: '#EEA71E' }}>500+</p>
                <p className="text-gray-600">Cães Adotados</p>
              </div>
              <div>
                <p className="text-3xl font-bold" style={{ color: '#23809B' }}>120+</p>
                <p className="text-gray-600">Voluntários</p>
              </div>
              <div>
                <p className="text-3xl font-bold" style={{ color: '#EEA71E' }}>8</p>
          ...
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                ...
                <p className="text-xl font-bold text-gray-900">Rex - Esperando por você!</p>
              </div>
            </div>
            
            {/* Decorative elements */}
            <div className="absolute -top-4 -right-4 w-24 h-24 rounded-full opacity-20 blur-2xl" style={{ backgroundColor: '#EEA71E' }}></div>
            <div className="absolute -bottom-4 -left-4 w-32 h-32 rounded-full opacity-20 blur-2xl" style={{ backgroundColor: '#23809B' }}></div>
          </div>
        </div>
      </div>
    </section>
